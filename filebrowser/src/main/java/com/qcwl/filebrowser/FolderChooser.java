...
import com.qcwl.filebrowser.adapters.CustomAdapter;
import com.qcwl.filebrowser.adapters.CustomAdapterItemClickListener;
import com.qcwl.filebrowser.fileoperations.FileIO;
import com.qcwl.filebrowser.fileoperations.Operations;
import com.qcwl.filebrowser.interfaces.IContextSwitcher;
import com.qcwl.filebrowser.listeners.OnFileChangedListener;
import com.qcwl.filebrowser.listeners.SearchViewListener;
import com.qcwl.filebrowser.listeners.TabChangeListener;
import com.qcwl.filebrowser.models.FileItem;
import com.qcwl.filebrowser.utils.AssortedUtils;
import com.qcwl.filebrowser.utils.Permissions;
...
public class FolderChooser extends AppCompatActivity implements OnFileChangedListener, IContextSwitcher {
    ...
    private void loadUi() {
        ...
        mBottomView.setItems(R.xml.bottom_nav_items_folderchooser);
